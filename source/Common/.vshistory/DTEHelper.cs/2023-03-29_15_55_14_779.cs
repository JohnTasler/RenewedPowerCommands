...
namespace Tasler.RenewedPowerCommands.Common
{
	public static class DTEHelper
	{
		...
		public static bool IsProjectNode(UIHierarchyItem item)
		{
			...
			return (item.Object is Project project && project.Kind != "{66A26720-8FB5-11D2-AA7E-00C04F688DDE}") || (item.Object is ProjectItem && projectItem.Object is Project && ((Project)((ProjectItem)item.Object).Object).Kind != "{66A26720-8FB5-11D2-AA7E-00C04F688DDE}");
		}
