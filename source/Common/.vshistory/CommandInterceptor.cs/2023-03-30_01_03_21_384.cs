...
namespace Tasler.RenewedPowerCommands.Common
{
	internal class CommandInterceptor : IDisposable
	{
		...
		public CommandInterceptor(DTE dte, string guid, int commandId)
		{
			...
			{
				this.CommandEvents.AfterExecute += new _dispCommandEvents_AfterExecuteEventHandler(this, (UIntPtr)ldftn(OnAfterExecute));
				this.CommandEvents.BeforeExecute += new _dispCommandEvents_BeforeExecuteEventHandler(this, (UIntPtr)ldftn(OnBeforeExecute));
			}
		}
