...
namespace Tasler.RenewedPowerCommands.Commands
{
	...
	internal class CollapseProjectsCommand : DynamicCommand
	{
		...
		protected static UIHierarchy SolutionExplorer
		{
			get
			{
				if (CollapseProjectsCommand.s_solutionExplorer == null)
				{
					CollapseProjectsCommand.s_solutionExplorer = ((DTE2)DynamicCommand.Dte).ToolWindows.SolutionExplorer;
				}
				return CollapseProjectsCommand.s_solutionExplorer;
			}
		}
