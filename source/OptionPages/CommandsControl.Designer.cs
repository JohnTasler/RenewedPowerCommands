...
namespace Tasler.RenewedPowerCommands.OptionPages
{
	partial class CommandsControl
	{
		...
		private void InitializeComponent()
		{
			...
			this._gridVisibility.Dock = System.Windows.Forms.DockStyle.Fill;
			this._gridVisibility.Location = new System.Drawing.Point(0, 0);
			...
			this._gridVisibility.Size = new System.Drawing.Size(388, 285);
			this._gridVisibility.TabIndex = 0;
			this._gridVisibility.CellValueChanged += new System.Windows.Forms.DataGridViewCellEventHandler(this.gridVisibility_CellValueChanged);
			this._gridVisibility.MouseLeave += new System.EventHandler(this.gridVisibility_MouseLeave);
			// 
			// CommandsControl
			// 
