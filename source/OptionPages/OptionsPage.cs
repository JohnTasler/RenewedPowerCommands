...
namespace Tasler.RenewedPowerCommands.OptionPages
{
	...
	public class OptionsPage : DialogPage
	{
		...
		private static readonly Dictionary<string, Func<OptionsPage, DisabledEnabled>> s_commandNameMappings = new Dictionary<string, Func<OptionsPage, DisabledEnabled>>()
		{
			{ "CollapseProjectsCommand", p => p.CollapseProjectsCommand },
			{ "RemoveSortUsingsCommand", p => p.RemoveAndSortUsingsCommand },
		};
	}
}
