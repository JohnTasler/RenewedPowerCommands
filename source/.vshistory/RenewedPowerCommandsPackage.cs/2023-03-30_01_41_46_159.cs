				...
				if (args.CommandGuid == typeof(VSStd97CmdID).GUID.ToString())
				{
					...
					foreach (Document document in enumerable)
					{
						...
						if (document.ProjectItem.FileCodeModel != null
							...
							|| document.ProjectItem.ContainingProject.Kind == "{9A19103F-16F7-4668-BE54-9A1E7A4F7556}"
							|| document.ProjectItem.ContainingProject.Kind == "{778DAE3C-4631-46EA-AA77-85C1314464D9}"))
						{
							...
							if ((document.ProjectItem.ContainingProject.Kind == VSLangProj.PrjKind.prjKindCSharpProject || document.ProjectItem.ContainingProject.Kind == "{9A19103F-16F7-4668-BE54-9A1E7A4F7556}" || document.ProjectItem.ContainingProject.Kind == "{F184B08F-C81C-45F6-A57F-5ABD9991F28F}" || document.ProjectItem.ContainingProject.Kind == "{778DAE3C-4631-46EA-AA77-85C1314464D9}") && this.GeneralPage.RemoveAndSortUsingsOnSave)
							{
